#!/usr/bin/env python3
"""CO2/CH4 co-current membrane separation demo."""
...
def main(argv=None) -> int:
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "demo_results" / "membrane")
    parser.add_argument("--spec", type=Path, default=ROOT / "assets" / "templates" / "membrane.yaml")
